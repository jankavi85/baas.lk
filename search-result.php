...
<?php
    if($_POST){
        ...
        $sql=mysqli_query($database,"select * from users where user_firstname like '%$query%' or user_lastname like '%$query%' order by user_id");
                                                                                ...
                                                                                <div class="panel-body">
                                                                                    ...
                                                                                    <div class="col-md-6 column">
                                                                                        ...
                                                                                        <div class="col-md-4 column">
                                                                                             <a href="profile.php?user_username=<?php echo $rws['user_name'];?>"><button type="button" class="btn btn-primary">View</button></a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
