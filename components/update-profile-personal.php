<?php
    ...
    if(isset($_POST)){
        ...
        $sql1="UPDATE users SET user_backgroundpicture='$BackgroundNewImageName' WHERE user_name = '$temp'";
        $sql2="INSERT INTO users (user_backgroundpicture) VALUES ('$BackgroundNewImageName') WHERE user_name = '$temp'";
        ...
        $sql3="UPDATE users SET user_profession='$user_profession',user_address='$user_address',user_shortbio='$user_shortbio',user_longbio='$user_longbio',user_dob='$user_dob',user_gender='$user_gender',user_country='$user_country',user_website='$user_website',user_facebook='$user_facebook',user_twitter='$user_twitter',user_googleplus='$user_googleplus',user_skype='$user_skype',user_github='$user_github',user_youtube='$user_youtube',user_vimeo='$user_vimeo',user_pinterest='$user_pinterest' WHERE user_name = '$temp'";
